...
# TASK 1: Read maximal capacity
MaxStorageCapacity = readin("maxstoragecapacity.csv", default=50, dims=1)

# TASK 2: Read losses
StorageLosses = readin("storagelosses.csv", default=1, dims=1)
...
# TASK 1: Limit the sum over all fuel of StorageEnergyCapacity
@constraint(ESM, FuelSum[s in storages],
...
# TASK 2:  Here we have to account for losses. 
...
# TASK 2: We changed this constraint. 
